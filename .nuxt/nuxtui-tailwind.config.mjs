      ...
      import { customSafelistExtractor, generateSafelist } from "/tmp/purewebagency-nuxt/node_modules/@nuxt/ui/dist/runtime/utils/colors";
      ...
      export default {
        ...
        content: {
          files: [
            "/tmp/purewebagency-nuxt/node_modules/@nuxt/ui/dist/runtime/components/**/*.{vue,mjs,ts}",
            "/tmp/purewebagency-nuxt/node_modules/@nuxt/ui/dist/runtime/ui.config/**/*.{mjs,js,ts}"
          ],
          transform: {
            vue: (content) => {
